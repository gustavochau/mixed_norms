function [x_hist,error]=steff_aitken(f,p0,tol,max_iter)
...
for i=1:max_iter   % get ready to do a large, but finite, number of iterations.
    ...
    x_hist(i) = p0;
    error = abs(f(p0));
    if error<tol  % test to see if we are within tolerance.
